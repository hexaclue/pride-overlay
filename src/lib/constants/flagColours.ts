export const flagColours = {
    ...
    bigender: ["#ee79ac", "#fdf44c", "#ffffff", "#af6dbf", "#719fe4"],
    abrosexual: ["#75ca91", "#b3e4c7", "#ffffff", "#e695b5", "#d9446c"],
    mlm: [
        "#0b7c6a",
        "#42a4a5",
        "#5cc8d2",
    ...
    pansexual: ["#ff148c", "#ffda00", "#05aeff"],
    nonbinary: ["#fff433", "#ffffff", "#9b59d0", "#000000"],
    poc: [
        "#000000",
        "#654321",
        "#e70000",
    ...
    polyamorous: ["#0000ff", "#ff0000", "#000000"],
